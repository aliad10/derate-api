...
import {
  ExecuteFeedbackRequestDto,
  ExecuteFeedbackRequestsBatchDto,
  FeedbackRequestDto,
} from './dto';
...
export class FeedbackController {
  ...
  @UseGuards(AuthGuard('jwt'), RolesGuard)
  @Post('execute-batch')
  executeAddFeedbackTransactionsBatch(
    @Body() dto: ExecuteFeedbackRequestsBatchDto[]
  ) {
    return this.feedbackService.executeRequestsBatch(dto);
  }
}
